...
\begin{tabular}{lrrrrr}
    \toprule
        ...
        \midrule
        Kaggle Breast Cancer & $285$ & $30$ & $2$ & \textbf{class} \\
        Kaggle Loan & $X$ & $X$ & $X$ & \textbf{X} \\
        Wine Reviews & $84.123$ & $5$ & $29$ & \textbf{variety} \\
        AirBnB & $18.316$ & $99$ & $2$ & \textbf{price\_label} \\
        \bottomrule
    \end{tabular}
\end{table}
...
\begin{tabular}{lrrrrr}
    \toprule
        ...
        Loans & Precision & $X$ & $X$ & $X$ \\
            & Recall & $X$ & $X$ & $X$ \\
            & F1 & $X$ & $X$ & $X$ \\
        Wine Reviews & Precision & $0.686$ & $N/A^{*_2}$ & $0.793$ \\
            & Recall & $0.695$ & $N/A^{*_2}$ & $0.756$ \\
            & F1 & $0.690$ & $N/A^{*_2}$ & $0.770$ \\
        AirBnB & Precision & $X$ & $X$ & $X$ \\
            & Recall & $X$ & $X$ & $X$ \\
            & F1 & $0.308$ & $0.316$ & $0.358$ \\
        \bottomrule
    \end{tabular}
\end{table}
$*^1$ As measured on the crossvalidation, given that Kaggle holdout dataset is unlabeled.
